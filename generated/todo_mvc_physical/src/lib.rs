...
mod tests {
    ...
    fn generated_graph_matches_checked_scenario_output() {
        let expected: boon_dd::SmokeOutput = serde_json::from_str("{\n  \"monitor\": [\n    {\n      \"NodeValue\": {\n        \"epoch\": 1,\n        \"node\": \"DocumentOutput\",\n        \"owner\": \"Root\",\n        \"value_preview\": \"physical ready\"\n      }\n    }\n  ],\n  \"render\": [\n    {\n      \"PatchText\": {\n        \"node\": \"DocumentText\",\n        \"text\": \"physical ready\"\n      }\n    }\n  ],\n  \"effects\": [],\n  \"persistence\": []\n}")
            .expect("checked expected render JSON should deserialize");
        let scenario_steps: Vec<boon_dd::ScenarioStep> = serde_json::from_str("[{\"description\":\"render physical scene\",\"events\":[{\"Source\":{\"source\":\"scene.frame\",\"owner\":null,\"generation\":null,\"value\":\"EmptyRecord\"}}],\"actions\":[{\"source\":\"scene.frame\",\"owner\":null,\"generation\":null,\"value\":\"EmptyRecord\"}],\"commands\":[],\"expect_text\":\"physical ready\",\"expect_monitor_changed\":[\"DocumentOutput\",\"DocumentText\"]}]")
