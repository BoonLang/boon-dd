...
mod tests {
    ...
    fn generated_graph_matches_checked_scenario_output() {
        ...
        let scenario_steps: Vec<boon_dd::ScenarioStep> = serde_json::from_str("[{\"description\":\"book valid flight\",\"events\":[{\"Source\":{\"source\":\"store.sources.book_button.event.press\",\"owner\":null,\"generation\":null,\"value\":\"EmptyRecord\"}}],\"actions\":[{\"source\":\"store.sources.book_button.event.press\",\"owner\":null,\"generation\":null,\"value\":\"EmptyRecord\"}],\"commands\":[],\"expect_text\":\"booked\",\"expect_monitor_changed\":[\"DocumentOutput\",\"DocumentText\"]}]")
