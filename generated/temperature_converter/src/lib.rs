...
mod tests {
    ...
    fn generated_graph_matches_checked_scenario_output() {
        ...
        let scenario_steps: Vec<boon_dd::ScenarioStep> = serde_json::from_str("[{\"description\":\"convert celsius\",\"events\":[{\"Source\":{\"source\":\"celsius_input.text\",\"owner\":null,\"generation\":null,\"value\":{\"Text\":\"20\"}}}],\"actions\":[{\"source\":\"celsius_input.text\",\"owner\":null,\"generation\":null,\"value\":{\"Text\":\"20\"}}],\"commands\":[],\"expect_text\":\"68 F\",\"expect_monitor_changed\":[\"DocumentOutput\",\"DocumentText\"]}]")
