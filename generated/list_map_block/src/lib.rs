...
mod tests {
    ...
    fn generated_graph_matches_checked_scenario_output() {
        ...
        let scenario_steps: Vec<boon_dd::ScenarioStep> = serde_json::from_str("[{\"description\":\"map list through block\",\"events\":[{\"Source\":{\"source\":\"list\",\"owner\":null,\"generation\":null,\"value\":{\"List\":[{\"Text\":\"a\"},{\"Text\":\"b\"},{\"Text\":\"c\"}]}}}],\"actions\":[{\"source\":\"list\",\"owner\":null,\"generation\":null,\"value\":{\"List\":[{\"Text\":\"a\"},{\"Text\":\"b\"},{\"Text\":\"c\"}]}}],\"commands\":[],\"expect_text\":\"a,b,c\",\"expect_monitor_changed\":[\"DocumentOutput\",\"DocumentText\"]}]")
