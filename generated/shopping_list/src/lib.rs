...
mod tests {
    ...
    fn generated_graph_matches_checked_scenario_output() {
        ...
        let actions: Vec<boon_dd::SourceAction> = serde_json::from_str("[{\"source\":\"new_item_input.text\",\"owner\":null,\"generation\":null,\"value\":{\"Text\":\"bread\"}},{\"source\":\"new_item_input.event.key_down.key\",\"owner\":null,\"generation\":null,\"value\":{\"Tag\":{\"name\":\"Enter\",\"payload\":null}}}]")
