...
mod tests {
    ...
    fn generated_graph_matches_checked_scenario_output() {
        let expected: boon_dd::SmokeOutput = serde_json::from_str("{\n  \"monitor\": [\n    {\n      \"NodeValue\": {\n        \"epoch\": 1,\n        \"node\": \"DocumentOutput\",\n        \"owner\": \"Root\",\n        \"value_preview\": \"milk,bread\"\n      }\n    }\n  ],\n  \"render\": [\n    {\n      \"PatchText\": {\n        \"node\": \"DocumentText\",\n        \"text\": \"milk,bread\"\n      }\n    }\n  ],\n  \"effects\": [],\n  \"persistence\": []\n}")
            .expect("checked expected render JSON should deserialize");
        let scenario_steps: Vec<boon_dd::ScenarioStep> = serde_json::from_str("[{\"description\":\"add shopping item\",\"events\":[{\"Source\":{\"source\":\"new_item_input.text\",\"owner\":null,\"generation\":null,\"value\":{\"Text\":\"bread\"}}},{\"Source\":{\"source\":\"new_item_input.event.key_down.key\",\"owner\":null,\"generation\":null,\"value\":{\"Tag\":{\"name\":\"Enter\",\"payload\":null}}}}],\"actions\":[{\"source\":\"new_item_input.text\",\"owner\":null,\"generation\":null,\"value\":{\"Text\":\"bread\"}},{\"source\":\"new_item_input.event.key_down.key\",\"owner\":null,\"generation\":null,\"value\":{\"Tag\":{\"name\":\"Enter\",\"payload\":null}}}],\"commands\":[],\"expect_text\":\"milk,bread\",\"expect_monitor_changed\":[\"DocumentOutput\",\"DocumentText\"]}]")
