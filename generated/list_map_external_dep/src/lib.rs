...
mod tests {
    ...
    fn generated_graph_matches_checked_scenario_output() {
        ...
        let scenario_steps: Vec<boon_dd::ScenarioStep> = serde_json::from_str("[{\"description\":\"map list with external dependency\",\"events\":[{\"Source\":{\"source\":\"uppercase\",\"owner\":null,\"generation\":null,\"value\":{\"Tag\":{\"name\":\"True\",\"payload\":null}}}}],\"actions\":[{\"source\":\"uppercase\",\"owner\":null,\"generation\":null,\"value\":{\"Tag\":{\"name\":\"True\",\"payload\":null}}}],\"commands\":[],\"expect_text\":\"A,B,C\",\"expect_monitor_changed\":[\"DocumentOutput\",\"DocumentText\"]}]")
