...
mod tests {
    ...
    fn generated_graph_matches_checked_scenario_output() {
        let expected: boon_dd::SmokeOutput = serde_json::from_str("{\"monitor\":[{\"NodeValue\":{\"epoch\":1,\"node\":\"ListRetainRemove\",\"owner\":\"Root\",\"value_preview\":\"removed\"}}],\"render\":[{\"PatchText\":{\"node\":\"DocumentText\",\"text\":\"removed\"}}]}")
