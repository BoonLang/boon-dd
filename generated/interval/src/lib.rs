...
mod tests {
    ...
    fn generated_graph_matches_checked_scenario_output() {
        ...
        let scenario_steps: Vec<boon_dd::ScenarioStep> = serde_json::from_str("[{\"description\":\"synthetic tick\",\"events\":[{\"Source\":{\"source\":\"tick\",\"owner\":null,\"generation\":null,\"value\":\"EmptyRecord\"}}],\"actions\":[{\"source\":\"tick\",\"owner\":null,\"generation\":null,\"value\":\"EmptyRecord\"}],\"commands\":[],\"expect_text\":\"1\",\"expect_monitor_changed\":[\"TimerInterval\",\"Counter\",\"DocumentText\"]}]")
