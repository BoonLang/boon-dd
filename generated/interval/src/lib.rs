...
pub fn checked_scenario_steps() -> Vec<boon_dd::ScenarioStep> {
    serde_json::from_str("[{\"description\":\"synthetic tick\",\"events\":[{\"Source\":{\"source\":\"tick\",\"owner\":null,\"generation\":null,\"value\":\"EmptyRecord\"}}],\"actions\":[{\"source\":\"tick\",\"owner\":null,\"generation\":null,\"value\":\"EmptyRecord\"}],\"commands\":[],\"expect_text\":\"1\",\"expect_monitor_changed\":[\"TimerInterval\",\"Counter\",\"DocumentText\"]}]").expect("checked scenario steps should deserialize")
}
