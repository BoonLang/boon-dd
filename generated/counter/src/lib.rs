...
mod tests {
    ...
    fn generated_graph_matches_checked_scenario_output() {
        ...
        let actions: Vec<boon_dd::SourceAction> = serde_json::from_str("[{\"source\":\"store.sources.increment_button.event.press\",\"owner\":null,\"generation\":null,\"value\":\"EmptyRecord\"}]")
