...
mod tests {
    ...
    fn generated_graph_matches_checked_scenario_output() {
        ...
        let scenario_steps: Vec<boon_dd::ScenarioStep> = serde_json::from_str("[{\"description\":\"reactive retain switches visibility\",\"events\":[{\"Source\":{\"source\":\"selected_filter\",\"owner\":null,\"generation\":null,\"value\":{\"Tag\":{\"name\":\"Active\",\"payload\":null}}}}],\"actions\":[{\"source\":\"selected_filter\",\"owner\":null,\"generation\":null,\"value\":{\"Tag\":{\"name\":\"Active\",\"payload\":null}}}],\"commands\":[],\"expect_text\":\"active\",\"expect_monitor_changed\":[\"ListRetainReactive\",\"DocumentText\"]}]")
