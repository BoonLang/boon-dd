...
pub fn checked_scenario_steps() -> Vec<boon_dd::ScenarioStep> {
    serde_json::from_str("[{\"description\":\"selected branch visible\",\"events\":[{\"Source\":{\"source\":\"selected_filter\",\"owner\":null,\"generation\":null,\"value\":{\"Tag\":{\"name\":\"Active\",\"payload\":null}}}}],\"actions\":[{\"source\":\"selected_filter\",\"owner\":null,\"generation\":null,\"value\":{\"Tag\":{\"name\":\"Active\",\"payload\":null}}}],\"commands\":[],\"expect_text\":\"visible\",\"expect_monitor_changed\":[\"Visible\",\"DocumentText\"]}]").expect("checked scenario steps should deserialize")
}
