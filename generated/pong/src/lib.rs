...
pub fn checked_scenario_steps() -> Vec<boon_dd::ScenarioStep> {
    serde_json::from_str("[{\"description\":\"synthetic animation frame\",\"events\":[{\"Source\":{\"source\":\"store.sources.frame\",\"owner\":null,\"generation\":null,\"value\":{\"Record\":{\"delta\":{\"Number\":{\"Int\":16}},\"now\":{\"Number\":{\"Int\":16}}}}}}],\"actions\":[{\"source\":\"store.sources.frame\",\"owner\":null,\"generation\":null,\"value\":{\"Record\":{\"delta\":{\"Number\":{\"Int\":16}},\"now\":{\"Number\":{\"Int\":16}}}}}],\"commands\":[],\"expect_text\":\"frame 1\",\"expect_monitor_changed\":[\"DocumentOutput\",\"DocumentText\"]}]").expect("checked scenario steps should deserialize")
}
