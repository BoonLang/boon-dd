...
mod tests {
    ...
    fn generated_graph_matches_checked_scenario_output() {
        ...
        let scenario_steps: Vec<boon_dd::ScenarioStep> = serde_json::from_str("[{\"description\":\"enter accepted\",\"events\":[{\"Source\":{\"source\":\"key_down.key\",\"owner\":null,\"generation\":null,\"value\":{\"Tag\":{\"name\":\"Enter\",\"payload\":null}}}}],\"actions\":[{\"source\":\"key_down.key\",\"owner\":null,\"generation\":null,\"value\":{\"Tag\":{\"name\":\"Enter\",\"payload\":null}}}],\"commands\":[],\"expect_text\":\"accepted\",\"expect_monitor_changed\":[\"Accepted\",\"DocumentText\"]}]")
