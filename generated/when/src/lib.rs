...
pub fn checked_scenario_steps() -> Vec<boon_dd::ScenarioStep> {
    serde_json::from_str("[{\"description\":\"enter accepted\",\"events\":[{\"Source\":{\"source\":\"key_down.key\",\"owner\":null,\"generation\":null,\"value\":{\"Tag\":{\"name\":\"Enter\",\"payload\":null}}}}],\"actions\":[{\"source\":\"key_down.key\",\"owner\":null,\"generation\":null,\"value\":{\"Tag\":{\"name\":\"Enter\",\"payload\":null}}}],\"commands\":[],\"expect_text\":\"accepted\",\"expect_monitor_changed\":[\"Accepted\",\"DocumentText\"]}]").expect("checked scenario steps should deserialize")
}
