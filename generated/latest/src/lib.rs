...
pub fn checked_scenario_steps() -> Vec<boon_dd::ScenarioStep> {
    serde_json::from_str("[{\"description\":\"same epoch branch tie\",\"events\":[{\"Source\":{\"source\":\"a\",\"owner\":null,\"generation\":null,\"value\":{\"Text\":\"branch_a\"}}},{\"Source\":{\"source\":\"b\",\"owner\":null,\"generation\":null,\"value\":{\"Text\":\"branch_b\"}}}],\"actions\":[{\"source\":\"a\",\"owner\":null,\"generation\":null,\"value\":{\"Text\":\"branch_a\"}},{\"source\":\"b\",\"owner\":null,\"generation\":null,\"value\":{\"Text\":\"branch_b\"}}],\"commands\":[],\"expect_text\":\"branch_b\",\"expect_monitor_changed\":[\"Value\",\"DocumentText\"]}]").expect("checked scenario steps should deserialize")
}
