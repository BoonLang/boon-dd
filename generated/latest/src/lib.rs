...
mod tests {
    ...
    fn generated_graph_matches_checked_scenario_output() {
        ...
        let actions: Vec<boon_dd::SourceAction> = serde_json::from_str("[{\"source\":\"a\",\"owner\":null,\"generation\":null,\"value\":{\"Text\":\"branch_a\"}},{\"source\":\"b\",\"owner\":null,\"generation\":null,\"value\":{\"Text\":\"branch_b\"}}]")
