...
mod tests {
    ...
    fn generated_graph_matches_checked_scenario_output() {
        ...
        let scenario_steps: Vec<boon_dd::ScenarioStep> = serde_json::from_str("[{\"description\":\"update cell\",\"events\":[{\"Source\":{\"source\":\"cells.A1.text\",\"owner\":null,\"generation\":null,\"value\":{\"Text\":\"1\"}}}],\"actions\":[{\"source\":\"cells.A1.text\",\"owner\":null,\"generation\":null,\"value\":{\"Text\":\"1\"}}],\"commands\":[],\"expect_text\":\"A1=1\",\"expect_monitor_changed\":[\"DocumentOutput\",\"DocumentText\"]}]")
