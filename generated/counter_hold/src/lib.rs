...
pub fn checked_scenario_steps() -> Vec<boon_dd::ScenarioStep> {
    serde_json::from_str("[{\"description\":\"increment\",\"events\":[{\"Source\":{\"source\":\"store.sources.increment_button.event.press\",\"owner\":null,\"generation\":null,\"value\":\"EmptyRecord\"}}],\"actions\":[{\"source\":\"store.sources.increment_button.event.press\",\"owner\":null,\"generation\":null,\"value\":\"EmptyRecord\"}],\"commands\":[],\"expect_text\":\"1\",\"expect_monitor_changed\":[\"IncrementButtonEventPress\",\"Counter\",\"DocumentText\"]},{\"description\":\"persist and reload\",\"events\":[{\"Command\":{\"command\":\"enable_persistence\"}},{\"Source\":{\"source\":\"store.sources.increment_button.event.press\",\"owner\":null,\"generation\":null,\"value\":\"EmptyRecord\"}},{\"Command\":{\"command\":\"reload\"}}],\"actions\":[{\"source\":\"store.sources.increment_button.event.press\",\"owner\":null,\"generation\":null,\"value\":\"EmptyRecord\"}],\"commands\":[{\"command\":\"enable_persistence\"},{\"command\":\"reload\"}],\"expect_text\":\"1\",\"expect_monitor_changed\":[]}]").expect("checked scenario steps should deserialize")
}
