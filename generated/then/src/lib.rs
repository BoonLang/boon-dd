...
mod tests {
    ...
    fn generated_graph_matches_checked_scenario_output() {
        let expected: boon_dd::SmokeOutput = serde_json::from_str("{\"monitor\":[{\"NodeValue\":{\"epoch\":1,\"node\":\"ThenValue\",\"owner\":\"Root\",\"value_preview\":\"1\"}}],\"render\":[{\"PatchText\":{\"node\":\"DocumentText\",\"text\":\"1\"}}]}")
