...
mod tests {
    ...
    fn generated_graph_matches_checked_scenario_output() {
        ...
        let scenario_steps: Vec<boon_dd::ScenarioStep> = serde_json::from_str("[{\"description\":\"retain active rows and count\",\"events\":[{\"Source\":{\"source\":\"filter\",\"owner\":null,\"generation\":null,\"value\":{\"Tag\":{\"name\":\"Active\",\"payload\":null}}}}],\"actions\":[{\"source\":\"filter\",\"owner\":null,\"generation\":null,\"value\":{\"Tag\":{\"name\":\"Active\",\"payload\":null}}}],\"commands\":[],\"expect_text\":\"2\",\"expect_monitor_changed\":[\"DocumentOutput\",\"DocumentText\"]}]")
