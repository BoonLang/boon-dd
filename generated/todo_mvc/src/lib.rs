...
pub fn checked_scenario_steps() -> Vec<boon_dd::ScenarioStep> {
    serde_json::from_str("[{\"description\":\"add and count todos\",\"events\":[{\"Source\":{\"source\":\"store.sources.new_todo_input.text\",\"owner\":null,\"generation\":null,\"value\":{\"Text\":\"Buy milk\"}}},{\"Source\":{\"source\":\"store.sources.new_todo_input.event.key_down.key\",\"owner\":null,\"generation\":null,\"value\":{\"Tag\":{\"name\":\"Enter\",\"payload\":null}}}}],\"actions\":[{\"source\":\"store.sources.new_todo_input.text\",\"owner\":null,\"generation\":null,\"value\":{\"Text\":\"Buy milk\"}},{\"source\":\"store.sources.new_todo_input.event.key_down.key\",\"owner\":null,\"generation\":null,\"value\":{\"Tag\":{\"name\":\"Enter\",\"payload\":null}}}],\"commands\":[],\"expect_text\":\"2 todos\",\"expect_monitor_changed\":[\"DocumentOutput\",\"DocumentText\"]}]").expect("checked scenario steps should deserialize")
}
